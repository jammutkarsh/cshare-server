...
// GenerateJWT takes username as a parameter and returns a JSON web token(JWT) and an error if any.
...
// ValidateToken takes JWT as a parameter and returns nil error if the token is valid.
